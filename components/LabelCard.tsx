...
const LabelCard = ({
  ...
  return (
    <div className='flex flex-row items-center justify-between gap-2 pl-2'>
      ...
      />
      <div
        className={`w-[210px] h-[32px] bg-${label.color} rounded-[3px] cursor-pointer text-[14px] font-medium pl-3 flex items-center text-ellipsis whitespace-nowrap hover:brightness-[.80]`}
